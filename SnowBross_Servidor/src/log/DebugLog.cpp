...
DebugLog::DebugLog() {
	...
	archivo = dir.append("debug_log.txt");
	fecha = nullptr;
}
...
void DebugLog::loguear(std::string mensajeError, Log::LOG_TIPO tipo) throw (LogExcepcion) {
	return loguear(mensajeError.c_str(), tipo);
}
